 ...
 */
package com.nateyolles.aem.slingprovisioningdemo.it.launcher;
...
implements SlingRemoteTestParameters, SlingTestsCountChecker {
    ...
    public static final String TEST_SELECTOR = "com.nateyolles.aem.slingprovisioningdemo.it.tests";
